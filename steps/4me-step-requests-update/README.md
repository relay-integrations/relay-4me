# 4me-step-requests-update

This [4me](https://4me.com) step updates an existing 4me [request](https://help.4me.com/help/request/). The request is identified by the required input field `request_id`.
It sets an output, `request`, containing the updated request.
